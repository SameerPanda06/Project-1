...
const scheduleData = {
  ...
  Tuesday: [
    ...
    { time: '2:00-3:00', subject: 'Chemistry', classroom: '103' },
  ],
  Wednesday: [{ time: '11:00-12:00', subject: 'Math', classroom: '101' }],
  Thursday: [],
  Friday: [{ time: '1:00-2:00', subject: 'Physics', classroom: '102' }],
};
